...
from m4semantic_network import M4depthAblationParameters
...
class M4DepthOptions:
    def __init__(self, args):
        ...
        args.add_argument('--dataset',
                          default="",
                          choices=["midair", "midair1", "tartanair", "kitti-raw","wilduav", "uzh", "airsim", "cityscapes", "aeroscapes", "ninja2", "udd"],
