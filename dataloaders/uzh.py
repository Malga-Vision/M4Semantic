...
class DataLoaderUZH(DataLoaderGeneric):
    """Dataloader for the UZH dataset
    """
    def __init__(self, out_size=[384, 512]):
        super(DataLoaderUZH, self).__init__('uzh')
    ...
    def _set_output_size(self, out_size=[384, 512]):
        ...
        self.fx = 0.432 * self.out_size[1]
        self.fy = 0.577 * self.out_size[0]
        self.cx = 0.49 * self.out_size[1]
        self.cy = 0.493 * self.out_size[0]
    ...
    def _decode_samples(self, data_sample):
        ...
        #image2 = tf.image.grayscale_to_rgb(image)
