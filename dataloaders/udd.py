...
class DataLoaderUDD(DataLoaderGeneric):
    """Dataloader for the UDD dataset
    """
    def __init__(self, out_size=[300,400], crop=False):
        super(DataLoaderUDD, self).__init__('udd')

        self.in_size = [3000, 4000]
        self.class_count = 9
        self.class_index = {
        0: [(127, 175, 230), 'Sky'],
    ...
    def _set_output_size(self, out_size=[300, 400]):
    ...
    def get_dataset(self, usecase, settings, batch_size=3, out_size=[300, 400], crop=False):
        self.crop = crop
        ...
        super(DataLoaderUDD, self).get_dataset(usecase, settings, batch_size=batch_size, out_size=out_size)
