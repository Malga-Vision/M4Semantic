...
parser.add_argument("--db_path", default=os.path.join(*[dir_path,"..", "datasets","wildUAV"]), help="path to folder containing the databases")
parser.add_argument("--output_dir", default=os.path.join(*[dir_path,"..", "data", "wilduav"]), help="path to folder to store csv files")
a = parser.parse_args()
