...
parser.add_argument("--db_path", default=os.path.join(*[dir_path,"..", "datasets","UDD","UDD5"]), help="path to folder containing the databases")
parser.add_argument("--output_dir", default=os.path.join(*[dir_path,"..", "data", "udd"]), help="path to folder to store csv files")
a = parser.parse_args()
...
if __name__== "__main__":
    ...
    for nset, set in enumerate(data):
        ...
        with open(file_name, 'w') as file:
            ...
            imgs = os.listdir("/media/DATA_4TB/Yara/UDD/UDD5/src")
            traj_len = len(imgs)
            ...
            for index in range(traj_len):
                ...
                camera_l = os.path.join("src", imgs[index])
